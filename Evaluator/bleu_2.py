...
class bleu_2_score:
    ...
    def evaluate_bleu(self):
        ...
        # Calculate BLEU-2 score with smoothing function
        smoothing_function = SmoothingFunction().method1  # Laplace smoothing
        bleu_score = sentence_bleu([tokenized_values1], tokenized_values2, smoothing_function=smoothing_function, weights=(0.5, 0.5, 0, 0))
