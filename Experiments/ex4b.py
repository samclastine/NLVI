...
class VegaLiteEvaluator:
    def __init__(self, llm, output_filename="/output.csv"):
        ...
        Vega-lite Json:"""
        self.cot_CHAIN_PROMPT = PromptTemplate(input_variables=[ 'question', 'chat_history', "context"], template=CoT_chain_template)
        self.zero_CHAIN_PROMPT = PromptTemplate(input_variables=["cot_output","context"], template=zero_shot_chain_template)
        self.results = []
    def visQA_chain(self, dataFile, input):
        try:
            ...
            vis_cot_chain = ConversationalRetrievalChain.from_llm(
                ...
                chain_type="stuff",
                combine_docs_chain_kwargs={"prompt": cot_CHAIN_PROMPT},
            ...
            vis_zero_chain = ConversationalRetrievalChain.from_llm(
                ...
                retriever=csv_retriever,
                chain_type="stuff",
                combine_docs_chain_kwargs={"prompt": zero_CHAIN_PROMPT},
                verbose= True,
                output_key= "result",
                )
